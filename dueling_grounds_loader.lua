...
print("[DG] Loader build: 2026-08-16-DISCOVERY-NOLEARNING-1")
...
local configFn = Compile("Game Config", configSource)
local GameConfig = configFn()
if type(GameConfig) ~= "table" then
    error("[DG] Game Config returned an invalid table.")
end
